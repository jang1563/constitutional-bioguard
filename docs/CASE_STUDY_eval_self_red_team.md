...
documented account of how, at every step, the system LOOKED successful under the evaluation in use,
and how strengthening the evaluation reversed each conclusion. The deliverable is not the model
...
0.605 (teacher), and 0.121 is the eval's base rate (~random ranking). The student achieves high
...
broken; auditing your own classifier as adversarially as you would an adversary's is the job.
