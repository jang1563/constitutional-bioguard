...
set -e
cd /home/fs01/jak4013/constitutional-bioguard
export PYTHONUTF8=1 PYTHONUNBUFFERED=1 PYTHONPATH=$(pwd) HF_HOME=$HOME/.cache/huggingface
PY=/home/fs01/jak4013/.conda/envs/bioguard/bin/python
...
echo "=== train ==="
$PY scripts/train_v7c_distill.py --pool data/processed/distill_pool_bbllm.jsonl \
