...
Usage:
    python scripts/experiments/run_probe_ensemble.py                        # Llama default
    python scripts/experiments/run_probe_ensemble.py --model gemma-2-9b     # Gemma
    python scripts/experiments/run_probe_ensemble.py --model llama-3.1-8b --batch-size 2
"""
