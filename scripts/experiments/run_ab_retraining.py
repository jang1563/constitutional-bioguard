...
Designed to run on an HPC / NSF ACCESS GPU node. See scripts/experiments/ab_retraining.slurm
for a batch template.

Usage:
    python scripts/experiments/run_ab_retraining.py --variant both
    python scripts/experiments/run_ab_retraining.py --variant A_full
    python scripts/experiments/run_ab_retraining.py --variant both --external
"""
